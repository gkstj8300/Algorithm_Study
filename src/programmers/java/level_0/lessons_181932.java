...
//        		sb.append((i % 2 == 0 && code.charAt(i) != '1') ? code.charAt(i) : "");
        	} else if(mode == 1) {
        		if(code.charAt(i) != '1') {
        			if(i % 2 == 1) {
        				sb.append(code.charAt(i));
...
//        		sb.append((i % 2 == 1 && code.charAt(i) != '1') ? code.charAt(i) : "");
        	}
        }
	...
	public static void main(String[] args) {
		lessons_181932 lessons = new lessons_181932();
		lessons.solution("abc1abc1abc");
	}
